        ...
        <div class="container">
            ...
            <div class="card" style="width: 60rem;">
                <div class="card-body">
                    ...
                    <hr>
                    <form class="mb-3 col-md-12" action="{{ route('devis.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3 ">
                                ...
                                <label for="nom" class="form-label">NOM DU DEVIS <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="arreter" class="form-label">MONTANT TOTAL <span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    ...
                                    <label for="elements" class="form-label">Element 1 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte1" class="form-label">Quantité 1<span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u" class="form-label">Prix Unitaire 1 <span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    ...
                                    <label for="elements1" class="form-label">Element 2 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte2" class="form-label">Quantité 2<span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u1" class="form-label">Prix unitaire 2 <span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    ...
                                    <label for="elements2" class="form-label">Element 3 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte3" class="form-label">Quantité 3 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u2" class="form-label">Prix unitaire 3<span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    ...
                                    <label for="elements3" class="form-label">Element 4<span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte4" class="form-label">Quantité 4 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u3" class="form-label">Prix unitaire 4<span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    ...
                                    <label for="elements4" class="form-label">Element 5<span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte5" class="form-label">Quantité 5 <span class="text-danger"></span></label>
                                <input name="qte5" class="form-control" value="{{ old('qte5') }}" type="text" placeholder="Quantité 5" >
                            </div>
                            </div>
                            <div class="box-a">
                            <div class="mb-3">
                                <label for="prix_u4" class="form-label">Prix unitaire 5<span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    ...
                                    <label for="elements5" class="form-label">Element 6 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte6" class="form-label">Quantité 6 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u5" class="form-label">Prix unitaire 6<span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    ...
                                    <label for="elements6" class="form-label">Element 7 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte7" class="form-label">Quantité 7<span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u6" class="form-label">Prix unitaire 7 <span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    <!-- <label for="elements7" class="col-form-label text-md-right">Element 8 <span class="text-danger"></span></label> -->
                                     <label for="elements7" class="form-label">Element 8 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte8" class="form-label">Quantité 8 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u7" class="form-label">Prix unitaire 8 <span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    <!-- <label for="elements8" class="col-form-label text-md-right">Element 9 <span class="text-danger"></span></label> -->
                                     <label for="elements8" class="form-label">Element 9 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte9" class="form-label">Quantité 9 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u8" class="form-label">Prix unitaire 9 <span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    <!-- <label for="elements9" class="col-form-label text-md-right">Element 10 <span class="text-danger"></span></label> -->
                                     <label for="elements9" class="form-label">Element 10 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte10" class="form-label">Quantité 10 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u9" class="form-label">Prix unitaire 10 <span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    <!-- <label for="elements10" class="col-form-label text-md-right">Element 11 <span class="text-danger"></span></label> -->
                                     <label for="elements10" class="form-label">Element 11 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte11" class="form-label">Quantité 11 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u10" class="form-label">Prix unitaire 10 <span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    <!-- <label for="elements11" class="col-form-label text-md-right">Element 12 <span class="text-danger"></span></label> -->
                                     <label for="elements11" class="form-label">Element 12 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte12" class="form-label">Quantité 12 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u11" class="form-label">Prix unitaire 11 <span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    <!-- <label for="elements12" class="col-form-label text-md-right">Element 13 <span class="text-danger"></span></label> -->
                                     <label for="elements12" class="form-label">Element 13 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="qte13" class="form-label">Quantité 13 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u12" class="form-label">Prix unitaire 12 <span class="text-danger"></span></label>
                        ...
                        <div class="row">
                            ...
                            <div class="box-part ">
                                <div class="mb-3">
                                    <!-- <label for="elements13" class="col-form-label text-md-right">Element 14 <span class="text-danger"></span></label> -->
                                     <label for="elements13" class="form-label">Element 14 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                <!-- <label for="qte14" class="col-form-label text-md-right">Quantité 14 <span class="text-danger"></span></label> -->
                                 <label for="qte14" class="form-label">Quantité 14 <span class="text-danger"></span></label>
                            ...
                            <div class="mb-3">
                                ...
                                <label for="prix_u13" class="form-label">Prix unitaire 13 <span class="text-danger"></span></label>
