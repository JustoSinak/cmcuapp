                        ...
                        <div class="modal-header">
                            ...
                            <!--
                                <p class="btn btn-primary offset-2">Dr
                                    ...
                                    </strong> la liste des rendez-vous à cette date</p>
                            -->
                            <p class="bg-info rounded p-2 offset-2">Liste des rendez-vous à cette date</p>
                            @else
                            {{-- Auth()->user()->role_id==2 ? "DR": (in_array(Auth()->user()->sexe, ["Homme", "Maxculin"])? "M." : "Mme") --}}
                            <!--
                                <p class="bg-info rounded p-2 offset-2">Dr<strong>
                                        {{ Auth()->user()->name }} {{ Auth()->user()->prenom }}
                                    </strong> Aucun rendez-vous disponible <i class="fas fa-exclamation-circle"></i></p>
                            -->
                            <p class="bg-info rounded mx-auto p-2">Aucun rendez-vous disponible <i class="fas fa-exclamation-circle"></i></p>
                            @endif
